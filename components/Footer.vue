<template>
  <v-footer v-bind="localAttrs" :padless="padless">
    <v-card flat tile width="100%" class="coal lighten-1 text-center">
      <v-card-text>
      ...
      <v-card-text class="white--text coal">
        Copyright © {{ new Date().getFullYear() }}
        <a
          href="http://www.happydesigns.de/"
          target="_blank"
          rel="noopener"
          class="white--text"
        >happydesigns</a>
...
export default {
  data: () => ({
    icons: ["mdi-shield-account", "mdi-delete"],
